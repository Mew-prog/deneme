...
exports.run = async (bot, message, args) => {
    ...
    var cesaret = ['İğrenç bir ses tonuyla şarkı söyle', 'İnstagramda Veya YT de En Son İzledigin Sapık Şey', 'Bugün yaptığın bir şeyle alakalı uydurma kısa, komik bir hikaye anlat', 'Whatsappındaki son mesajlaşmanı bize oku', 'Çok yüksek bir sesle 3 saniye bağır']
