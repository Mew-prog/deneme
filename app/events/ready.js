...
module.exports = client => {
  ...
  //online = çevrimiçi
  console.log(`                                                                                                                                                                     `)
  client.user.setActivity(`E-Space Botumuz +22 Sunucu +4.7k Kullanıcı Vardır | Destekleğiniz İçin Teşşekürler Discord Adresimiz: https://discord.gg/YbGbSjJ`, { type: "PLAYING"});
  //LISTENING = DİNLİYOR
  //WATCHING = İZLİYOR
  //PLAYING = OYNUYOR 
